...
class DataStore:
    ...
    def __init__(self):
        self.rider_filename = "rider.pk1"
        self.driver_filename = "driver.pk1"
    ...
    def get_rider_filename(self):
        return self.rider_filename
    ...
    def write_rider_info(self, rider_info):
        self.write_file(self.rider_filename, rider_info)
        print("Rider info has been stored to database")

    def read_driver_info(self):
        return self.write_file(self.driver_filename)
    
    def write_driver_info(self, driver_info):
